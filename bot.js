...
function respond() {
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    postMessage("http://daddyleagues.com/usfl1/team/"+request.text.substring(5,8)+"/depthchart");
    this.res.end();
  } 
    ...
    this.res.writeHead(200);
    postMessage("https://docs.google.com/document/d/104X5ojmWa3SYvoMUr9zxI_b9vL3BXlE1SUVquJWXJt0");
    this.res.end();
  } 
    ...
    postMessage("http://daddyleagues.com/usfl1/team/"+request.text.substring(5,8)+"/schedule");
    this.res.end();
  }
    ...
    var rep = req.replace(/ /,"+");
    postMessage("http://daddyleagues.com/usfl1/players?name="+rep+"&position=all&team=all");
    ...
    this.res.writeHead(200);
    postMessage("http://www.reddit.com/r/usfl");
    this.res.end();
  } 
